        ...
        if (event == "telemetry") {
          ...
          */
          ...
          vector<double> y_waypoints;
            ...
            double delay_px = v * dt;
            double delay_py = 0.0;
            double delay_psi = - v * delta / Lf * dt;
            double delay_v = v + a * dt;
            double delay_cte = cte + v * sin(epsi) * dt;
            double delay_epsi = epsi - v * delta / Lf * dt;
            
            Eigen::VectorXd state(6);
           state << delay_px, delay_py, delay_psi, delay_v, delay_cte, delay_epsi;
            cout << "State: v=" << delay_v << " cte=" << delay_cte << " epsi=" << delay_epsi << endl;
